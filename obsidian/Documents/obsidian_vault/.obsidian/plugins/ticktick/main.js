...
var productName = "TickTick";
var clientId = "OcvIKsf0r001X1iDAS";

// main.ts
var client_id = clientId;
var callbackUrl = `https://${domain}/integrations/oauth/obsidian`;
var sort = {
      ...
      callback: async () => {
        if (this.checkUserLoginStatus()) {
          try {
            ...
            new import_obsidian.Notice("Data fetched failed");
          }
        }
      }
    });
...
var CreateTaskModal = class extends import_obsidian.Modal {
  ...
  onOpen() {
    ...
    const projectComp = new import_obsidian.DropdownComponent(projectLine).addOptions(
      this.plugin.settings.projects.filter((project) => !project.closed).sort(sort.sortOrder).reduce(
        (id2Name, project) => {
